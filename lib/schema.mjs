...
import { AGENT_ID_ALIASES, AGENT_IDS } from "./agent-targets.mjs";

const SCHEMA_AGENT_IDS = [...AGENT_IDS, ...AGENT_ID_ALIASES.keys()];
  ...
  properties: {
    ...
    agentSupport: {
      ...
      properties: {
        ...
        selected: {
          type: "array",
          items: { type: "string", enum: SCHEMA_AGENT_IDS },
          minItems: 1,
          uniqueItems: true,
