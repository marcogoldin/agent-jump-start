...
try {
  ...
  // Simulate a realistic drift where the operator hand-edited the managed
  // file but left the Agent Jump Start provenance header in place, so sync
  // can still recognise it as its own artifact and heal the drift.
  writeFileSync(
